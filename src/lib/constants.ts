...
export const APP_OWNERSHIP_HEADER = process.env.APP_OWNERSHIP_HEADER;
export const APP_OWNERSHIP_PAYLOAD = process.env.APP_OWNERSHIP_PAYLOAD;
export const APP_OWNERSHIP_SIGNATURE = process.env.APP_OWNERSHIP_SIGNATURE;
export const APP_ICON_URL = `${APP_URL}/icon.png`;
export const APP_OG_IMAGE_URL = `${APP_URL}/icon.png`;
